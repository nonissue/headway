...
export function Footer({ lastUpdated, onRefresh }: FooterProps) {
    ...
    return (
        <div className="relative z-0 flex items-center justify-between border-t border-l-4 border-border/50 border-l-foreground/20 px-4 py-2 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-sm backdrop-blur-md sm:p-4 sm:pb-4">
